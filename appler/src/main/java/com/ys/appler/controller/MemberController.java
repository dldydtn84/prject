...
public class MemberController {
  ...
  public ModelAndView changePass(@RequestParam("nowpass") String nowpass,
      @RequestParam("newpass") String newpass, @RequestParam("againpass") String againpass,
      ModelAndView mav, String userid, Model model) throws Exception {
  ...
  public ModelAndView nicknamechange(@RequestParam("nickname") String nickname,
      @RequestParam("userid") String userid, Model model, ModelAndView mav) throws Exception {
  ...
  public ModelAndView namechange(@RequestParam("name") String name,
      @RequestParam("userid") String userid, ModelAndView mav) throws Exception {
