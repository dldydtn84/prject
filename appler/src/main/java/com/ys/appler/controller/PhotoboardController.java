...
public class PhotoboardController {
  ...
  public String list(Model model,
      @RequestParam(value = "perPageNum", defaultValue = "9") int perPageNum,
  ...
  public String writepro(@RequestParam("uploadfile") MultipartFile uploadfile, Model model,
      PhotoBoardDto photoBoardDto, HttpServletRequest request) throws IOException {
  ...
  @PostMapping("/modify")
  public String modifypro(@RequestParam("no") int no, MultipartFile uploadfile,
      PhotoBoardDto photoBoardDto, HttpServletRequest request) throws IOException {
    String result = photoBoardService.saveFile(uploadfile);
