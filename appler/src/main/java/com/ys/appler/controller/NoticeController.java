...
public class NoticeController {
  ...
  public String list(Model model, NoticeBoardDto noticeBoardDto,
  ...
  public String read(@RequestParam("no") int no, Model model, NoticeBoardDto noticeBoardDto,
  ...
  public String deletePro(Model model, @RequestParam("no") int no, HttpServletResponse response)
      throws Exception {
